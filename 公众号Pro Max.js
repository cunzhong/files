...
<h3>内容</h3>
<textarea id="contentInput" rows="4">焦虑不是因为努力，
而是因为努力没有反馈。</textarea>
<div id="contentCount" class="counter"></div>
...
contentInput.oninput=generatePoster;
...
let contentLines=getWrappedLines(ctx,contentInput.value,820,4);
let cy=780;
...
let footerY=1440-footerHeight-80;
let radius=40;

ctx.save();
ctx.beginPath();
ctx.roundRect(60,footerY,960,footerHeight,radius);
...
document.getElementById("contentCount").innerText="内容字数："+contentInput.value.length;
}
